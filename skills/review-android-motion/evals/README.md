...
|---|---|---|---|
| `no-motion-language` | 10–12, 20–29, 30, 40, 50, 60, 70, 80 | code only | Is the violation found at all, and is the correct code left alone? |
...
Class A is the first to be filled in: 21–29 follow case 20's shape.
